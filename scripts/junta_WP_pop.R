junta_WP_pop <- function (list_pop, dados_WP) {
  ...
  list_pop$saidas$data_WP_I_saida <- str_c(as.character(list_pop$saidas$data),"-", list_pop$saidas$WP_I_saida)
  list_pop$saidas$data_WP_F_saida <- str_c(as.character(list_pop$saidas$data),"-", list_pop$saidas$WP_F_saida)
  ...
  list_pop$saidas <- list_pop$saidas %>%
    dplyr::select(saida, data, barco, datahora_I, lng_I, lat_I, WP_I, rota, equipe, litros_abastecidos, OBS, data_WP_F_saida)
  ...
  list_pop$saidas <- list_pop$saidas %>%
    dplyr::select(saida, data, barco, datahora_I, lng_I, lat_I, WP_I, datahora_F, lng_F, lat_F, WP_F, rota, equipe, litros_abastecidos, OBS)
  ...
  list_pop$clima$data_WP_I_clima <- str_c(as.character(list_pop$clima$data),"-", list_pop$clima$WP_I_clima)
  list_pop$clima$data_WP_F_clima <- str_c(as.character(list_pop$clima$data),"-", list_pop$clima$WP_F_clima)
  ...
  list_pop$clima <- list_pop$clima %>%
    dplyr::select(saida, datahora_I, lng_I, lat_I, WP_I, dir_vento, veloc_vento, beaufort, cobert_nuvens, visibilidade, reflexo, OBS, data_WP_F_clima)
  ...
  list_pop$clima <- list_pop$clima %>%
    dplyr::select(saida, datahora_I, lng_I, lat_I, WP_I, datahora_F, lng_F, lat_F, WP_F, dir_vento, veloc_vento, beaufort, cobert_nuvens, visibilidade, reflexo, OBS)
  ...
  list_pop$avistagens$data_WP_I <- str_c(as.character(list_pop$avistagens$data),"-", list_pop$avistagens$WP_I_grupo)
  list_pop$avistagens$data_WP_F <- str_c(as.character(list_pop$avistagens$data),"-", list_pop$avistagens$WP_F_grupo)
  ...
  list_pop$avistagens <- list_pop$avistagens %>%
    dplyr::select(saida, data, grupo, datahora_I, lng_I, lat_I, WP_I, num_fotos, estado, coesao, tam_grupo, tam_min, tam_max, n_neonatos, n_infantes, n_juvenis, n_adultos, OBS, data_WP_F)
  ...
  list_pop$avistagens <- list_pop$avistagens %>%
    dplyr::select(saida, data, grupo, datahora_I, lng_I, lat_I, WP_I, datahora_F, lng_F, lat_F, WP_F, num_fotos, estado, coesao, tam_grupo, tam_min, tam_max, n_neonatos, n_infantes, n_juvenis, n_adultos, OBS)
