...
Nosso banco de dados é composto de um conjunto de tabelas, unificando as informações de todas as entradas de dados: **planilha de campo**, **arquivo de trajeto**, **arquivo de WP**, **sonda multiparâmetro**, **arquivo de fotos**, e **arquivos do Raven**.

Mudanças futuras:

-   Aba excel **"WP_sub"** com "saida", "data", "hora", "WP_sub" "lng", "lat", "OBS"
-   Aba excel **"pausa"** com "saida", "data", "WP_I", "WP_F", "OBS"
...
pdm <- dm_from_data_frames(clima = lista_pop$clima,
  ...
  dm_create_graph(rankdir = "BT",
                  graph_name = "Banco de Dados de Parões Populacionais",
...
# Criando o objeto para datamodelr
cdm <- dm_from_data_frames(clima = lista_com$clima,
  ...
  dm_create_graph(rankdir = "BT",
                  graph_name = "Banco de Dados de Comportamento",
                  col_attr = c("column", "type"),
                  view_type = "keys_only")
