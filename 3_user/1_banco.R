...
caminho_RDS_1 <-  paste(pasta_proj, "/4_export/1_banco/bd_L1.rds", sep = "")
...
# Definindo caminho para o arquivo RDS
caminho_RDS_2 <-  paste(pasta_proj, "/4_export/1_banco/bd_L2.rds", sep = "")
...
# Definindo caminho para o arquivo RDS
caminho_RDS_3 <-  paste(pasta_proj, "/4_export/1_banco/bd_L3.rds", sep = "")
